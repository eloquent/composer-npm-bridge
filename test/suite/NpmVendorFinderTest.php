...
class NpmVendorFinderTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $this->linkB2 = new Link('vendorB/packageB', 'eloquent/composer-npm-bridge', new Constraint('=', '1.0.0'));
        $this->linkC1 = new Link('vendorC/packageC', 'vendorZ/packageZ', new Constraint('=', '1.0.0'));
        $this->linkC2 = new Link('vendorC/packageC', 'eloquent/composer-npm-bridge', new Constraint('=', '1.0.0'));
        $this->linkD1 = new Link('vendorD/packageD', 'eloquent/composer-npm-bridge', new Constraint('=', '1.0.0'));
